        ...
        Try
            If aSMTP.Count > 1 Then
                ...
                If HttpContext.Current.Session("AnexoFaleConosco").ToString() <> "" Then
                    ...
                    HttpContext.Current.Session.Remove("AnexoFaleConosco")
                    HttpContext.Current.Session.Remove("CaminhoAnexo")
                End If
                cc = HttpContext.Current.Session("EmailUsuario").ToString()
