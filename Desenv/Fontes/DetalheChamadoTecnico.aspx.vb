...
Public Class DetalheChamadoTecnico
    ...
    Private Sub AdicionarItem(ByRef dt As DataTable, Optional ByVal nIndice As Integer = 0)
        ...
        'Item do Chamado Técnico
        dr("ItemChamado") = ObterIndiceAlfa() 'CStr(CInt(dt(nIndice - 1)("ItemChamado")) + 1)
        dr("CodigoSituacao") = ""
    ...
    Private Function ObterIndiceAlfa() As String
        ...
        If dt IsNot Nothing Then
            ...
            indice = dt.Rows(nPosicao).Item("ItemChamado").ToString
        ...
        End If
        Return indice
        Session.Add("indice", indice)
    End Function

    Private Function ObterIndice() As String
        Dim indice As Integer = 0
        Dim resultadoIndice As String = ""
        Dim dt As DataTable
        dt = DirectCast(ViewState("ChamadoTecnico"), DataTable)
        If dt IsNot Nothing Then
            For Each dr As DataRow In dt.Rows
