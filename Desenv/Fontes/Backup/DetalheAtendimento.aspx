...
<asp:Content ID="Content1" ContentPlaceHolderID="SubMaster" runat="server">
    ...
    <asp:Panel ID="pnlCabecalho" runat="server"> <br />
        ...
        <asp:HiddenField ID="txtPossuiGarantia" runat="server" Value="N" /><br/> <br/>
        ...
        <asp:DropDownList ID="drpOcorrencia" runat="server" DataTextField="DescricaoOcorrencia" DataValueField="CodigoOcorrencia" CssClass="drop" /> <br/> <br/>
        ...
        <uc11:HourBox ID="oHoraTermino" runat="server" Text="" /> &nbsp;  &nbsp; <br/> <br/>
        ...
        <ContentTemplate> <br/>
            ...
            <asp:Panel ID="Panel1" runat="server" CssClass="gridFundo">
        ...
        <asp:Panel ID="pnlEnviaAnalise" runat="server">
            <asp:CheckBox ID="chkEnviaAnalise" runat="server" Text="Solicitar análise de troca de peças" /><br/><br/><br/>
        </asp:Panel>
        ...
        <asp:DropDownList ID="drpServico" runat="server" DataTextField="descricao" DataValueField="codigo" /><br/> <br/>

        <asp:Panel ID="pnlDescricaoROT" runat="server" Visible="false">
            <asp:Label ID="lblTitRelROT" runat="server" CssClass="label" Text="Análise OS:"  /> <br/>
            <asp:TextBox ID="txtROT" runat="server" CssClass="textArea2" TextMode="MultiLine" Enabled="false" /> <br/> <br/>
        </asp:Panel>
        <asp:Panel ID="pnlDescricaoOS2" runat="server" Visible="false">
            <asp:Label ID="lblAnaliseOS2" runat="server" CssClass="label" Text="Análise OS 2:"  /> <br/>
            <asp:TextBox ID="txtAnaliseOS2" runat="server" CssClass="textArea2" TextMode="MultiLine" Enabled="false" /> <br/> <br/>
        </asp:Panel>

        <asp:Label ID="lblTitDefeito" runat="server" CssClass="label" Text="Defeito:" /> <br/> 
        <asp:TextBox ID="txtDefeito" runat="server" CssClass="textArea2" TextMode="MultiLine" /> <br/> <br/>

        <asp:Label ID="lblTitCausa" runat="server" CssClass="label" Text="Causa:" /> <br/>
        <asp:TextBox ID="txtCausa" runat="server" CssClass="textArea2" TextMode="MultiLine" /> <br/> <br/>

        <asp:Label ID="lblTitServExecutado" runat="server" CssClass="label" Text="Serv. Executado:" /> <br/>
    ...
    <asp:Panel ID="pnlBotoes" runat="server" width="100%"> <br />
        <table width="100%">
            <tr>
                <td>
