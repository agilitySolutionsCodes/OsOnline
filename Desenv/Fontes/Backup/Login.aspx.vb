...
Partial Public Class Login
    ...
    Private Sub objLogin_Authenticate(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.AuthenticateEventArgs) Handles objLogin.Authenticate
        ...
        Try
            ...
            If oRetWs.RETORNO.SUCESSO Then
                ...
                'Dim ticket As New FormsAuthenticationTicket(1, oAuth.UserName, Now, Now.AddMinutes(15), True, sGrupos)
    ...
    Private Sub ConsultarDadosEmail()
        ...
        Try
            ...
            aEmail.Add(sServidor.Replace("SMTPPROD.CAREFUSION.COM:25", "SMTPPROD.CAREFUSION.COM"))
            'aEmail.Add("192.168.41.10") 'sServidor)
            aEmail.Add(sUsuario)
            aEmail.Add(sSenha)
            aEmail.Add(sAuth)
