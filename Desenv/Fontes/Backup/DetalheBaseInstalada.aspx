...
<asp:Content ID="Content1" ContentPlaceHolderID="SubMaster" runat="server">
    ...
    <asp:Panel ID="pnlCabecalho" runat="server" > <br />
        ...
        <asp:Label ID="lblProduto" runat="server" /><br/> <br/>
        ...
        <asp:DropDownList ID="drpStatus" runat="server" DataTextField="DescricaoStatus" DataValueField="CodigoStatus" CssClass="drop" /> <br/> <br/>   

        <asp:Label ID="lblTitEndereco" runat="server" CssClass="label" Text="Endereço:" /> <br/>
        <asp:TextBox ID="txtEndereco" runat="server" TextMode="MultiLine" CssClass="textArea2" /> <br/> <br/>
        ...
        <span id="spanParametros" runat="server">
            <uc1:ClienteView ID="txtCliente" runat="server" ExibirBusca="false" TipoBuscaSelecionado="CPF_CNPJ" /> <br/>
        </span> <br /> 
        
        <asp:Label ID="lblTitTecnico" runat="server" CssClass="label" Text="Técnico:" />
        <asp:DropDownList ID="drpTecnico" runat="server" DataTextField="NomeTecnico" DataValueField="CodigoTecnico" CssClass="drop" /> <br/> <br/>
        ...
        <asp:TextBox ID="txtSerieNota" runat="server" CssClass="textBox" /> <br/> <br/>
        ...
        <asp:TextBox ID="txtItemPedido" runat="server" CssClass="textBox" /> <br/> <br/>
        ...
        <uc5:DateBox ID="oDataGarantia" runat="server"  /> <br/> <br/>

        <asp:Label ID="lblTitLocalInstalacao" runat="server" CssClass="label" Text="Local Instalação:" /> <br/>
        <asp:TextBox ID="txtLocalInstalacao" runat="server" TextMode="MultiLine" CssClass="textArea2" /> <br/> <br/>
    ...
    <asp:Panel runat="server" ID="pnlEmail" Visible="false">
        ...
        <asp:Label ID="lblTitMensagem" runat="server" CssClass="label" Text="Mensagem:" /> <br/>
        <asp:TextBox ID="txtMensagem" runat="server" TextMode="MultiLine" CssClass="textArea2" /> <br/>
    </asp:Panel>
