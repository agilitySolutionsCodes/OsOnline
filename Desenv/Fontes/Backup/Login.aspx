<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="OrdemServico.Login"
...
<asp:Content ID="Principal" ContentPlaceHolderID="cMaster" runat="Server">
    <asp:Label ID="lblTitulo" runat="server" Text="Login" CssClass="label"/> <br /> <br />
